...
Lang = ['english', 'spanish', 'arabic', 'mandarin', 'french', 'korean', 'portuguese', 'russian', 'dutch', 'turkish']
labels = np.array(shuffle(Lang, random_state=1))
np.savetxt("labels.dat", labels ,fmt='%s')
